                ...
                <form action="" id="sales-form">
                    ...
                    <div id="pos-field">
                        <div id="menu-list">
                            ...
                            <fieldset>
                                ...
                                <div id="item-list" class="py-1 overflow-auto">
                                    ...
                                    ?>
                                    <div class="col 
                                        <?= isset($cid) && $cid == $row['category_id'] ? "" : "d-none" ?> 
                                            menu-item" data-cat-id='<?= $row['category_id'] ?>'>
                                            <div class="card">
                                                <img src="<?= "/ffos/" . $row['image'] ?>" class="card-img-top" alt="<?= $row['name'] ?>">
                                                <div class="card-body">
                                                    ...
                                                    <button class="btn btn-default bg-gradient-warning btn-block rounded-pill px-2 border my item-btn" type="button" data-id='<?= $row['id'] ?>
                                                ' data-price='<?= $row['price'] ?>'>Add to order</button>
                                                </div>
                                            </div>
                                    </div>
                                    <?php endwhile; ?>
                            ...
                            <div class="text-center py-2">
                                <button class="btn btn-lg btn-warning bg-gradient-warning rounded-pill px-4 place-order">Place Order</button>
                            </div>
                        </div>
                        <div id="order-list" class="bg-gradient-dark p-1">
                            ...
                            <div class="d-flex w-100 mb-2">
                                <h3 class="col-5 mb-0"></h3>
                                <h3 class="col-7 mb-0 bg-gradient-light rounded-0 text-right px-0"><input type="hidden" step="any" name="tendered_amount" class="form-control rounded-0 text-right bg-gradient-light font-weight-bolder" style="font-size:1em" required value="0"></h3>
                            </div>
                            <div class="d-flex w-100 mb-2">
                                <h3 class="col-5 mb-0"></h3>
                               <h3 class="col-7 mb-0 bg-gradient-light rounded-0 text-right" id="change" style="display:none;">0.00</h3>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    // ✅ Auto-update tendered to match grand total
    $('input[name="tendered_amount"]').val(gt.toFixed(2)).trigger('input')
}
    $(function(){
