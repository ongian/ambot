					...
					?>
						<tr>
							...
							<td class="text-center">
								<img src="<?= isset($row['image']) ? '../' . $row['image'] : 
									(is_file('../uploads/menus/'.$row['code'].'.jpg') ? '../uploads/menus/'.$row['code'].'.jpg' : 
									(is_file('../uploads/menus/'.$row['code'].'.jpeg') ? '../uploads/menus/'.$row['code'].'.jpeg' : 
									(is_file('../uploads/menus/'.$row['code'].'.png') ? '../uploads/menus/'.$row['code'].'.png' : '../uploads/menus/default.png'))) ?>" 
									class="menu-img img-thumbnail" alt="<?= $row['name'] ?>">
							</td>
