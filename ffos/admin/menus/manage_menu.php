...
<div class="container-fluid">
	<form action="" id="menu-form">
		...
		<div class="form-group">
			...
			<small class="text-muted">The image will be saved with the menu code as its name.</small>
		</div>
		<div class="form-group d-flex justify-content-center">
			<img src="<?php echo isset($image) ? '../' . $image : 
						(isset($code) && is_file('../uploads/menus/'.$code.'.jpg') ? '../uploads/menus/'.$code.'.jpg' : 
						(isset($code) && is_file('../uploads/menus/'.$code.'.jpeg') ? '../uploads/menus/'.$code.'.jpeg' : 
						(isset($code) && is_file('../uploads/menus/'.$code.'.png') ? '../uploads/menus/'.$code.'.png' : '../uploads/menus/default.png'))) ?>" 
	...
	$(document).ready(function(){
		...
		function displayImg(input,_this) {
			if (input.files && input.files[0]) {
				...
				$('#cimg').attr('src', "<?php echo isset($image) ? '../' . $image : 
						(isset($code) && is_file('../uploads/menus/'.$code.'.jpg') ? '../uploads/menus/'.$code.'.jpg' : 
						(isset($code) && is_file('../uploads/menus/'.$code.'.jpeg') ? '../uploads/menus/'.$code.'.jpeg' : 
						(isset($code) && is_file('../uploads/menus/'.$code.'.png') ? '../uploads/menus/'.$code.'.png' : '../uploads/menus/default.png'))) ?>");
			}
